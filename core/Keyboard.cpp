...
const char* getKeyName(keyboard::KeySymbol key) {
  ...
  switch (key) {
    ...
    case GK_KP_COMMA:
      return "kp_comma";
    case GK_KP_EQUALSAS400:
      return "kp_equalsas400";
    case GK_INTERNATIONAL1:
      return "international1";
    case GK_INTERNATIONAL2:
      return "international2";
    case GK_INTERNATIONAL3:
      return "international3";
    case GK_INTERNATIONAL4:
      return "international4";
    case GK_INTERNATIONAL5:
      return "international5";
    case GK_INTERNATIONAL6:
      return "international6";
    case GK_INTERNATIONAL7:
      return "international7";
    case GK_INTERNATIONAL8:
      return "international8";
    case GK_INTERNATIONAL9:
    ...
    case GK_KP_000:
      return "kp_000";
    case GK_THOUSANDSSEPARATOR:
      return "thousandsseparator";
    case GK_DECIMALSEPARATOR:
      return "decimalseparator";
    case GK_CURRENCYUNIT:
      return "currencyunit";
    case GK_CURRENCYSUBUNIT:
      return "currencysubunit";
    case GK_KP_LEFTPAREN:
      return "kp_leftparen";
    case GK_KP_RIGHTPAREN:
      return "kp_rightparen";
    case GK_KP_LEFTBRACE:
      return "kp_leftbrace";
    case GK_KP_RIGHTBRACE:
      return "kp_rightbrace";
    case GK_KP_TAB:
      return "kp_tab";
    case GK_KP_BACKSPACE:
      return "kp_backspace";
    case GK_KP_A:
      return "kp_a";
    case GK_KP_B:
    ...
    case GK_KP_GREATER:
      return "kp_greater";
    case GK_KP_AMPERSAND:
      return "kp_ampersand";
    case GK_KP_DBLAMPERSAND:
      return "kp_dblampersand";
    case GK_KP_VERTICALBAR:
      return "kp_verticalbar";
    case GK_KP_DBLVERTICALBAR:
    ...
    case GK_KP_MEMSTORE:
      return "kp_memstore";
    case GK_KP_MEMRECALL:
      return "kp_memrecall";
    case GK_KP_MEMCLEAR:
      return "kp_memclear";
    case GK_KP_MEMADD:
      return "kp_memadd";
    case GK_KP_MEMSUBTRACT:
      return "kp_memsubtract";
    case GK_KP_MEMMULTIPLY:
      return "kp_memmultiply";
    case GK_KP_MEMDIVIDE:
      return "kp_memdivide";
    case GK_KP_PLUSMINUS:
      return "kp_plusminus";
    case GK_KP_CLEAR:
      return "kp_clear";
    case GK_KP_CLEARENTRY:
    ...
    case GK_AC_REFRESH:
      return "ac_refresh";
    case GK_AC_BOOKMARKS:
      return "ac_bookmarks";
    case GK_BRIGHTNESSDOWN:
      return "brightnessdown";
    case GK_BRIGHTNESSUP:
      return "brightnessup";
    case GK_DISPLAYSWITCH:
      return "displayswitch";
    case GK_KBDILLUMTOGGLE:
      return "kbdillumtoggle";
    case GK_KBDILLUMDOWN:
      return "kbdillumdown";
    case GK_KBDILLUMUP:
      return "kbdillumup";
    case GK_EJECT:
...
KeySymbol scanCodeToKeySymbol(int scanCode) {
  switch (scanCode) {
    ...
    case SDL_SCANCODE_LEFTBRACKET:
      return GK_LEFTBRACKET;
    case SDL_SCANCODE_RIGHTBRACKET:
      return GK_RIGHTBRACKET;
    ...
    case SDL_SCANCODE_PRINTSCREEN:
      return GK_PRINTSCREEN;
    case SDL_SCANCODE_SCROLLLOCK:
      return GK_SCROLLLOCK;
    ...
    case SDL_SCANCODE_NUMLOCKCLEAR:
      return GK_NUMLOCKCLEAR;
    case SDL_SCANCODE_KP_DIVIDE:
      return GK_KP_DIVIDE;
    case SDL_SCANCODE_KP_MULTIPLY:
      return GK_KP_MULTIPLY;
    ...
    case SDL_SCANCODE_NONUSBACKSLASH:
      return GK_NONUSBACKSLASH;
    case SDL_SCANCODE_APPLICATION:
      return GK_APPLICATION;
    ...
    case SDL_SCANCODE_VOLUMEDOWN:
      return GK_VOLUMEDOWN;
    case SDL_SCANCODE_KP_COMMA:
      return GK_KP_COMMA;
    case SDL_SCANCODE_KP_EQUALSAS400:
      return GK_KP_EQUALSAS400;
    case SDL_SCANCODE_INTERNATIONAL1:
      return GK_INTERNATIONAL1;
    case SDL_SCANCODE_INTERNATIONAL2:
      return GK_INTERNATIONAL2;
    case SDL_SCANCODE_INTERNATIONAL3:
      return GK_INTERNATIONAL3;
    case SDL_SCANCODE_INTERNATIONAL4:
      return GK_INTERNATIONAL4;
    case SDL_SCANCODE_INTERNATIONAL5:
      return GK_INTERNATIONAL5;
    case SDL_SCANCODE_INTERNATIONAL6:
      return GK_INTERNATIONAL6;
    case SDL_SCANCODE_INTERNATIONAL7:
      return GK_INTERNATIONAL7;
    case SDL_SCANCODE_INTERNATIONAL8:
      return GK_INTERNATIONAL8;
    case SDL_SCANCODE_INTERNATIONAL9:
      return GK_INTERNATIONAL9;
    ...
    case SDL_SCANCODE_THOUSANDSSEPARATOR:
      return GK_THOUSANDSSEPARATOR;
    case SDL_SCANCODE_DECIMALSEPARATOR:
      return GK_DECIMALSEPARATOR;
    case SDL_SCANCODE_CURRENCYUNIT:
      return GK_CURRENCYUNIT;
    case SDL_SCANCODE_CURRENCYSUBUNIT:
      return GK_CURRENCYSUBUNIT;
    case SDL_SCANCODE_KP_LEFTPAREN:
      return GK_KP_LEFTPAREN;
    case SDL_SCANCODE_KP_RIGHTPAREN:
      return GK_KP_RIGHTPAREN;
    case SDL_SCANCODE_KP_LEFTBRACE:
      return GK_KP_LEFTBRACE;
    case SDL_SCANCODE_KP_RIGHTBRACE:
      return GK_KP_RIGHTBRACE;
    case SDL_SCANCODE_KP_TAB:
      return GK_KP_TAB;
    case SDL_SCANCODE_KP_BACKSPACE:
      return GK_KP_BACKSPACE;
    ...
    case SDL_SCANCODE_AC_FORWARD:
      return GK_AC_FORWARD;
    case SDL_SCANCODE_AC_STOP:
      return GK_AC_STOP;
    case SDL_SCANCODE_AC_REFRESH:
      return GK_AC_REFRESH;
    case SDL_SCANCODE_AC_BOOKMARKS:
      return GK_AC_BOOKMARKS;
    case SDL_SCANCODE_BRIGHTNESSDOWN:
      return GK_BRIGHTNESSDOWN;
    case SDL_SCANCODE_BRIGHTNESSUP:
      return GK_BRIGHTNESSUP;
    case SDL_SCANCODE_DISPLAYSWITCH:
      return GK_DISPLAYSWITCH;
    case SDL_SCANCODE_KBDILLUMTOGGLE:
      return GK_KBDILLUMTOGGLE;
    case SDL_SCANCODE_KBDILLUMDOWN:
      return GK_KBDILLUMDOWN;
    case SDL_SCANCODE_KBDILLUMUP:
      return GK_KBDILLUMUP;
