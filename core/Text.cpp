...
Text::Text(std::string_view str, bool argRawText, int argMaxWidth, bool wordWrap) {
  width = 0;
  height = 0;
...
void Text::setText(std::string_view argStr, bool argRawText, int argMaxWidth, bool argWordWrap) {
  str = argStr;
  rawText = argRawText;
